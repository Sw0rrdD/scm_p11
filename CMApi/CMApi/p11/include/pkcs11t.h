...
// CK_PTR is defined in cryptoki.h, windows version cannot find it with same header relationship
// redefine it here if not defined
#ifndef CK_PTR 
#define CK_PTR *
#endif
...
/* an value, at least 32 bits long */
typedef int CK_INT;
...
typedef struct CK_SLOT_INFO {
  CK_UTF8CHAR   slotDescription[64];  /* blank padded */ /* Serail Number */
  CK_UTF8CHAR   manufacturerID[32];   /* blank padded */ /* Issuer ID */
  CK_FLAGS      flags;
...
#define CKS_RO_SO_FUNCTIONS     5UL
...
/* CKR_COPY_PROHIBITED and CKR_ACTION_PROHIBITED are new for v2.4 */
...
#define CKR_USER_NEED_LOGGED_OUT              0x00000106UL
...
typedef struct CK_C_INITIALIZE_ARGS {
  CK_CREATEMUTEX FuncCreateMutex;
  CK_DESTROYMUTEX FuncDestroyMutex;
  CK_LOCKMUTEX FuncLockMutex;
  CK_UNLOCKMUTEX FuncUnlockMutex;
  CK_FLAGS flags;
