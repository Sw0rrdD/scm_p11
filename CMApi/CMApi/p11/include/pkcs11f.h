...
/* C_GenerateExchangeKeyPair for WT1 interface.
 */
CK_PKCS11_FUNCTION_INFO(C_GenerateExchangeKeyPair)
#ifdef CK_NEED_ARG_LIST
(
	CK_SESSION_HANDLE hSession,             /* the session's handle */
	CK_MECHANISM_PTR pMechanism, 			/* key deriv. mech. */
...
CK_PKCS11_FUNCTION_INFO(C_GenerateLocalSessKey)
#ifdef CK_NEED_ARG_LIST
(
	CK_SESSION_HANDLE hSession,		/* the session's handle */
	CK_MECHANISM_PTR pMechanism, 	/* key deriv. mech. */
...
CK_PKCS11_FUNCTION_INFO(C_WrapLocalSessKey)
#ifdef CK_NEED_ARG_LIST
(
	CK_SESSION_HANDLE hSession,		/* the session's handle */
...
CK_PKCS11_FUNCTION_INFO(C_UnwrapRemoteSessKey)
#ifdef CK_NEED_ARG_LIST
(
	CK_SESSION_HANDLE hSession,		/* the session's handle */
...
CK_PKCS11_FUNCTION_INFO(C_DeriveSessKey)
#ifdef CK_NEED_ARG_LIST
(
	CK_SESSION_HANDLE hSession,		/* the session's handle */
	CK_MECHANISM_PTR pMechanism,	/* key deriv. mech. */
...
CK_PKCS11_FUNCTION_INFO(C_PointMultiply)
#ifdef CK_NEED_ARG_LIST
(
	CK_SESSION_HANDLE hSession,		/* the session's handle */
...
(
	CK_SESSION_HANDLE hSession, 	/* the session's handle */
	CK_EXTEND_IN_PTR pExtendIn, 	/* input */
	CK_EXTEND_OUT_PTR pExtendOut, 	/* output */
...
#ifdef CK_NEED_ARG_LIST
(
	CK_BYTE flagType  /* flags to be cleaned */
);
#endif

CK_PKCS11_FUNCTION_INFO(C_EncryptUpdate_Extend)
#ifdef CK_NEED_ARG_LIST
(
	CK_SESSION_HANDLE hSession,		/* the session's handle */
	CK_BYTE_PTR pPart,				/* the plaintext data */
...
CK_PKCS11_FUNCTION_INFO(C_DecryptUpdate_Extend)
#ifdef CK_NEED_ARG_LIST
(
	CK_SESSION_HANDLE hSession,		/* session's handle */
 ...
 */
CK_PKCS11_FUNCTION_INFO(C_UnvarnishedTransmission)
#ifdef CK_NEED_ARG_LIST
(
